...
Read the skill file at `~/.cursor/skills/sdd-visual/SKILL.md` and follow it exactly.
...
4. Run the sub-skills in this exact order, loading each from `~/.cursor/skills/{name}/SKILL.md`:
