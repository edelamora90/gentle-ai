...
- macOS/Linux: `~/.kiro/skills/sdd-visual/SKILL.md`
- Windows: `%USERPROFILE%\\.kiro\\skills\\sdd-visual\\SKILL.md`
...
4. Run the sub-skills in this exact order, loading each from the same skills root:
